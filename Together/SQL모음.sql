...
UPDATE MEMBER SET 
MEMBER_PW = '$2a$10$ROj8yFNM0YkVdLyEtolIbeyaynEP9FlKab9GQc2.11PjOD1NOr55a'
WHERE MEMBER_NO = 1;
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', '20250211104412_00001.jpg','cat1.jpg' , 0, 1500);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', '20250211104412_00002.jpg', 'cat2.jpg', 0, 1497);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', '20250211104412_00003.jpg', 'cat3.jpg', 0, 1496);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', '20250211104412_00004.jpg', 'cat4.jpg', 0, 1494);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', '20250211104412_00005.jpg', 'cat5.jpg', 0, 1491);
...
SELECT BOARD_NO, BOARD_TITLE, MEMBER_NICKNAME, READ_COUNT,
     ...
     WHERE I.BOARD_NO = B.BOARD_NO AND IMG_ORDER = 0) THUMBNAIL
  FROM "BOARD" B
  JOIN "MEMBER" USING(MEMBER_NO)
  WHERE BOARD_DEL_FL = 'N'
  AND BOARD_CODE = 1
...
SELECT BOARD_NO, BOARD_TITLE, BOARD_CONTENT, READ_COUNT ,MEMBER_NICKNAME, MEMBER_NO,
		...
		TO_CHAR(B_CREATE_DATE, 'YYYY"년" MM"월" DD"일" HH24:MI:SS') B_UPDATE_DATE, 
...
INSERT INTO BOARD_IMG VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/', '20250212102412_00005.jpg','cat5.jpg' , 4, 1500);
...
-- 회원 프로필 이미지 변경
UPDATE MEMBER SET
PROFILE_IMG = '/resources/images/member/tomato.webp'
WHERE MEMBER_NO = 1;
COMMIT; 
...
WHERE BOARD_NO = 1
AND MEMBER_NO = 1;
DELETE FROM BOARD_IMG WHERE IMG_NO = 13;
...
SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL, 2 IMG_ORDER,
		1502 BOARD_NO FROM DUAL)A;


-- INSERT ALL 테이블 VALUES(), 테이블 VALUES()
...
--AND (BOARD_TITLE LIKE '%test%' OR BOARD_CONTENT LIKE '%수정%');
