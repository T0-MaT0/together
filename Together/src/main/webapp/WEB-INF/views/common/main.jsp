...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <img src="/resources/images/mainbanner.png" alt="">
        </div>
    </section>
    ...
    <section class="purchase-section">
        ...
        <div class="product-list">
            <div class="product">
                <img src="/resources/images/produceSample.png" alt="공구 세트">
                <p class="product-name">공구 세트</p>
                <p class="price">44,400원 → 39,800원</p>
    ...
    <section class="process-section">
        <h3 class="sub-title">이용 프로세스</h3>
        <h2 class="main-title">공동구매를 쉽고 빠르게 경험해 보세요.</h2>
        ...
        <div class="info-section">
            ...
            <div class="image-content">
                <img src="/resources/images/main1.png" alt="공동구매 이미지">
            </div>
        </div>
        
        <div class="info-section reverse">
            <div class="image-content">
                <img src="/resources/images/main2.png" alt="사업자 설명 이미지">
            </div>
            <div class="text-content">
        ...
        <div class="info-section">
            ...
            <div class="image-content">
                <img src="/resources/images/main3.png" alt="손을 모으는 이미지">
            </div>
        </div>
    ...
    <section class="hot-products">
        ...
        <div class="hot-product-list">
            ...
            <div class="hot-product"><img src="/resources/images/produceSample.png" alt="공구 세트"></div>
            <div class="hot-product"><img src="/resources/images/produceSample.png" alt="공구 세트"></div>
            <div class="hot-product"><img src="/resources/images/produceSample.png" alt="공구 세트"></div>
            <div class="hot-product"><img src="/resources/images/produceSample.png" alt="공구 세트"></div>
        </div>
