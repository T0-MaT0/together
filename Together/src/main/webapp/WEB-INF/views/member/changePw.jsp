...
<body>
    ...
    <section class="find-container">
        ...
        <div class="find-content">
            <form action="/member/changePw" method="POST" name="findPwFrm" id="findPwFrm">
                ...
                <input type="hidden" name="authority" id="authority-input" value="2">
                    ...
                    <div id="new-pw-area" class="input-area area-first">
                        <label for="memberPw">새 비밀번호</label>
                        <input type="password" name="memberPw" id="memberPw" class="memberNewPw">
                    </div>
                    <div id="new-pw-check-area" class="input-area area-last">
                    ...
                    <button id="change-pw" type="submit">비밀번호 변경하기</button>
                </div>
