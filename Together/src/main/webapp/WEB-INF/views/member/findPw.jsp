...
<head>
    ...
    <title>개인인비밀번호찾기폼</title>
    <link rel="stylesheet" href="/resources/css/find-id-style.css">
</head>
<body>
    ...
    <section class="find-container">
        ...
        <div class="find-button-section">
            <div id="find-id-section" class="no-click">아이디 찾기</div>
            <div id="find-pw-section" class="yes-click">비밀번호 찾기</div>
        </div>
