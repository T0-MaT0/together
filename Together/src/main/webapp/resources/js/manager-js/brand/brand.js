function boardProduct(memberNo) {
...
// function brandProfile(boardNo){
//     console.log(boardNo);

//     location.href="/manageBrand/brandProfile/2?boardNo="+boardNo+"&cp=1";
// }
...
function boardList(boardCode, memberNo, cp) {
    ...
    fetch("/manageBrand/brandProfile/" + boardCode + "?memberNo=" + memberNo)
        .then(resp => resp.json())
        .then(result => {
            ...
            for(let i=0; i<subMenuBtn.length; i++){
                ...
                if(boardCode == i){
                    ...
                    switch(i){
                        case 0: title = "상품 목록";  break;
                        case 1: title = "1:1 문의";  break;
                        case 2: title = "광고 문의"; break;
